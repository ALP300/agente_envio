...
🔗 ¡Síguenos en nuestras redes como *PMI Lima Perú Chapter* para no perderte ninguna novedad! 
...
const sendVideoMessages = async (client, media) => {
  fs.readFile(filePath, "utf8", async (err, data) => {
    ...
    for (let index = 0; index < first10.length; index++) {
      ...
      console.log(`Esperando ${waitTime / 1000} segundos antes de la siguiente iteración...`);
